...
function heroAction(hero, power, city) {
...
let hero1 = heroAction("Spider-Man", "web slinging", 'Queens')
console.log(hero1)

console.log(heroAction("Magneto", "magnetic field manipulation", 'Genosha'))
...
function animeHeroes(hero, powers) {
    return `${hero} uses ${powers} to defeat enemies` 
}

animeHeroes('Hakari', 'Tanjiro', 'Luffy')
animeHeroes('Private Pure Love Train', 'Water Breathing and Hinokami Kagura', 'the Human-Human Fruit Model: Nika')
...
villains('Doctor Octopus', 'Time Square', 'destroying cars with his mechanical arms')
villains('Electro', 'Central Park', 'overloading the city power grid')
villains('Vulture', 'Empire State Building', 'swooping down and grabbing people off the streets')
villains('Sandman', 'Brooklyn Bridge', 'turning the bridge into sand')
...
// Call the function below for Kraven the Hun
...
// Step 2: Define a function with an appropriate name. 
function moreHero(hero, secretIdentity, city, affiliation, archNemesis, catchphrase) {
    console.log("Hero: " + secretIdentity + " Birthplace: " + city + " Alliance: " + affiliation + "Rival: " + archNemesis + " Quote: " + " catchphrase ")
}
// Step 3: Idenitfy the inputs and add them as parameters.
...
moreHero("T'Challa", "Wakanda", "Avengers", "Killmonger", "Wakanda Forever")
moreHero('Bruce Wayne', 'Gotham City', 'Justice League', 'Joker', 'I am vengeance, I am the night, I am Batman')
...
moreHero('Tony Stark', 'NYC', 'Avengers', 'The Mandarin', 'I am Iron Man')